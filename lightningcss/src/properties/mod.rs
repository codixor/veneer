...
use crate::values::{
    alpha::*, color::*, easing::EasingFunction, ident::DashedIdentReference,
    ident::NoneOrCustomIdentList, image::*, length::*, position::*, rect::*, shape::FillRule,
    size::Size2D, time::Time,
};
    ...
    impl<'i> schemars::JsonSchema for PropertyId<'i> {
      ...
      fn json_schema(r#gen: &mut schemars::r#gen::SchemaGenerator) -> schemars::schema::Schema {
        macro_rules! property {
          ($n: literal) => {
            fn property(_: &mut schemars::r#gen::SchemaGenerator) -> schemars::schema::Schema {
