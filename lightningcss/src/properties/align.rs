            ...
            Err(_) => {
                ...
                match align {
                    ...
                    AlignContent::ContentDistribution(value) => {
                        JustifyContent::ContentDistribution(value.clone())
                    }
        ...
        W: std::fmt::Write,
    {
        ...
        let is_equal = match self.justify {
            ...
            JustifyContent::ContentPosition {
                overflow: o,
                value: c,
            } if matches!(self.align, AlignContent::ContentPosition { overflow: o2, value: c2 } if o == o2 && c == c2) => {
                true
            }
            _ => false,
        };
...
impl<'i> Parse<'i> for JustifySelf {
    fn parse<'t>(input: &mut Parser<'i, 't>) -> Result<Self, ParseError<'i, ParserError<'i>>> {
        ...
        if input
            .try_parse(|input| input.expect_ident_matching("stretch"))
            .is_ok()
        {
...
impl ToCss for PlaceSelf {
        ...
        W: std::fmt::Write,
    {
        ...
        let is_equal = match &self.justify {
            ...
            JustifySelf::SelfPosition {
                overflow: o,
                value: c,
            } if matches!(&self.align, AlignSelf::SelfPosition  { overflow: o2, value: c2 } if o == o2 && c == c2) => {
                true
            }
            _ => false,
        };
        ...
        W: std::fmt::Write,
    {
        ...
        let is_equal = match &self.justify {
            ...
            JustifyItems::SelfPosition {
                overflow: o,
                value: c,
            } if matches!(&self.align, AlignItems::SelfPosition { overflow: o2, value: c2 } if o == o2 && c == c2) => {
                true
            }
            _ => false,
        };
