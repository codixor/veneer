...
use crate::properties::font::{
    FontFamily, FontStretch, FontStyle as FontStyleProperty, FontWeight,
};
...
pub enum FontStyle {
    ...
    Oblique(
        #[cfg_attr(feature = "serde", serde(default = "FontStyle::default_oblique_angle"))]
        Size2D<Angle>,
    ),
}
...
impl<'i> RuleBodyItemParser<'i, FontFaceProperty<'i>, ParserError<'i>>
    for FontFaceDeclarationParser
{
