...
impl<'a, 'o, 'i, T: crate::traits::AtRuleParser<'i>> AtRuleParser<'i>
    ...
    fn rule_without_block(
        ...
        match prelude {
            ...
            AtRulePrelude::CustomMedia(name, query) => {
                ...
                self.rules
                    .0
                    .push(CssRule::CustomMedia(CustomMediaRule { name, query, loc }));
                Ok(())
            }
...
impl<'a, 'o, 'b, 'i, T: crate::traits::AtRuleParser<'i>> AtRuleParser<'i>
    ...
    fn rule_without_block(
        ...
        match prelude {
            AtRulePrelude::Layer(names) => {
                ...
                self.rules
                    .0
                    .push(CssRule::LayerStatement(LayerStatementRule { names, loc }));
                Ok(())
            }
            AtRulePrelude::Unknown(name, prelude) => {
                self.rules.0.push(CssRule::Unknown(UnknownAtRule {
    ...
    fn parse_block<'t>(
        ...
        match prelude {
            AtRulePrelude::FontFace => {
                ...
                self.rules
                    .0
                    .push(CssRule::FontFace(FontFaceRule { properties, loc }));
                Ok(())
            }
            ...
            AtRulePrelude::Media(query) => {
                ...
                self.rules
                    .0
                    .push(CssRule::Media(MediaRule { query, rules, loc }));
                Ok(())
            }
            ...
            AtRulePrelude::MozDocument => {
                ...
                self.rules
                    .0
                    .push(CssRule::MozDocument(MozDocumentRule { rules, loc }));
                Ok(())
            }
            AtRulePrelude::Layer(names) => {
                ...
                self.rules
                    .0
                    .push(CssRule::LayerBlock(LayerBlockRule { name, rules, loc }));
                Ok(())
            }
            AtRulePrelude::Property(name) => {
                self.rules
                    .0
                    .push(CssRule::Property(PropertyRule::parse(name, input, loc)?));
                Ok(())
            }
            ...
            AtRulePrelude::StartingStyle => {
                ...
                self.rules
                    .0
                    .push(CssRule::StartingStyle(StartingStyleRule { rules, loc }));
                Ok(())
            }
            AtRulePrelude::ViewTransition => {
                self.rules
                    .0
                    .push(CssRule::ViewTransition(ViewTransitionRule::parse(
                        input, loc,
                    )?));
                Ok(())
            }
