...
// Vendored crate — suppress pre-existing clippy warnings from macro-generated code.
#![allow(
...
mod tests {
    use crate::css_modules::{
        CssModuleExport, CssModuleExports, CssModuleReference, CssModuleReferences,
    };
    use crate::dependencies::Dependency;
    use crate::error::{
        Error, ErrorLocation, MinifyErrorKind, ParserError, PrinterErrorKind, SelectorError,
    };
    ...
    fn test_with_printer_options<'i, 'o>(
        source: &'i str,
        expected: &'i str,
        options: PrinterOptions<'o>,
    ) {
    ...
    "#},
      ...
      "#},
        ...
        minify_test(
            ".foo { aspect-ratio: auto 2 / 3 }",
            ".foo{aspect-ratio:auto 2/3}",
        );
        minify_test(
            ".foo { aspect-ratio: 2 / 3 auto }",
            ".foo{aspect-ratio:auto 2/3}",
        );
    ...
    fn test_vertical_align() {
        ...
        minify_test(
            ".foo { vertical-align: 0.3em }",
            ".foo{vertical-align:.3em}",
        );
    }
    ...
    fn test_selectors() {
        ...
        minify_test(
            ":nth-last-col(2n) {width: 20px}",
            ":nth-last-col(2n){width:20px}",
        );
        minify_test(
            ":nth-last-col(10n-1) {width: 20px}",
            ":nth-last-col(10n-1){width:20px}",
        );
        minify_test(
            ":nth-last-col(-n+2) {width: 20px}",
            ":nth-last-col(-n+2){width:20px}",
        );
        minify_test(
            ":nth-last-col(even) {width: 20px}",
            ":nth-last-col(2n){width:20px}",
        );
        minify_test(
            ":nth-last-col(odd) {width: 20px}",
            ":nth-last-col(odd){width:20px}",
        );
        minify_test(
        ...
        minify_test(
            ".x:has(.bar, #foo) {color:red}",
            ".x:has(.bar,#foo){color:red}",
        );
        minify_test(
            ".x:has(span + span) {color:red}",
            ".x:has(span+span){color:red}",
        );
      ...
      "#},
        ...
        minify_test(
            "a:is([data-test]) { color: yellow }",
            "a[data-test]{color:#ff0}",
        );
        ...
        minify_test(
            "a:is(.foo .bar) { color: yellow }",
            "a:is(.foo .bar){color:#ff0}",
        );
        minify_test(
            ":is(.foo, .bar) { color: yellow }",
            ":is(.foo,.bar){color:#ff0}",
        );
        minify_test(
            "a:is(:not(.foo)) { color: yellow }",
            "a:not(.foo){color:#ff0}",
        );
        minify_test(
            "a:is(:first-child) { color: yellow }",
            "a:first-child{color:#ff0}",
        );
        minify_test(
            "a:is(:has(.foo)) { color: yellow }",
            "a:has(.foo){color:#ff0}",
        );
        ...
        for name in &[
            ...
            minify_test(
                &format!(
                    ":root::{}(foo.bar.baz):only-child {{position: fixed}}",
                    name
                ),
    ...
    fn test_calc() {
        ...
        minify_test(".foo { width: calc(200px / +1) }", ".foo{width:200px}");
        minify_test(
            ".foo { width: calc(1.1e+1px + 1.1e+1px) }",
            ".foo{width:22px}",
        );
        minify_test(
            ".foo { border-width: calc(1px + 2px) }",
        ...
        minify_test(
            ".foo { border-width: clamp(1px, 2px, 3px) }",
            ".foo{border-width:2px}",
        );
        minify_test(
            ".foo { border-width: clamp(1px, 10px, 3px) }",
            ".foo{border-width:3px}",
        );
        minify_test(
            ".foo { border-width: clamp(5px, 2px, 10px) }",
            ".foo{border-width:5px}",
        );
        minify_test(
        ...
        minify_test(
            ".foo { border-width: clamp(1px, 2pt, 1in) }",
            ".foo{border-width:2pt}",
        );
        minify_test(
      ...
      "#},
        ...
        minify_test(
            ".foo { margin: round(to-zero, -23px, 5px) }",
            ".foo{margin:-20px}",
        );
        minify_test(
            ".foo { margin: round(nearest, -23px, 5px) }",
            ".foo{margin:-25px}",
        );
        minify_test(
            ".foo { margin: calc(10px * round(22, 5)) }",
            ".foo{margin:200px}",
        );
        minify_test(".foo { width: rem(18px, 5px) }", ".foo{width:3px}");
        minify_test(".foo { width: rem(-18px, 5px) }", ".foo{width:-3px}");
        minify_test(
            ".foo { width: rem(18px, 5vw) }",
            ".foo{width:rem(18px,5vw)}",
        );
        minify_test(
            ".foo { rotate: rem(-140deg, -90deg) }",
            ".foo{rotate:-50deg}",
        );
        minify_test(".foo { rotate: rem(140deg, -90deg) }", ".foo{rotate:50deg}");
        minify_test(
            ".foo { width: calc(10px * rem(18, 5)) }",
            ".foo{width:30px}",
        );
        minify_test(".foo { width: mod(18px, 5px) }", ".foo{width:3px}");
        minify_test(".foo { width: mod(-18px, 5px) }", ".foo{width:2px}");
        minify_test(
            ".foo { rotate: mod(-140deg, -90deg) }",
            ".foo{rotate:-50deg}",
        );
        minify_test(
            ".foo { rotate: mod(140deg, -90deg) }",
    ...
    fn test_trig() {
        ...
        // );
        minify_test(
            ".foo { width: calc(100px * sin(45deg))",
            ".foo{width:70.7107px}",
        );
        minify_test(
            ".foo { width: calc(100px * sin(.125turn))",
            ".foo{width:70.7107px}",
        );
        minify_test(
    ...
    fn test_exp() {
        ...
        minify_test(
            ".foo { width: hypot(1px, 2px, 3px)",
            ".foo{width:3.74166px}",
        );
        minify_test(
            ".foo { width: hypot(1px, 2vw)",
            ".foo{width:hypot(1px,2vw)}",
        );
        minify_test(
            ".foo { width: hypot(1px, 2px, 3vw)",
            ".foo{width:hypot(1px,2px,3vw)}",
        );
        minify_test(
            ".foo { width: calc(100px * hypot(3, 4))",
            ".foo{width:500px}",
        );
        minify_test(
            ".foo { width: calc(1px * pow(2, sqrt(100))",
            ".foo{width:1024px}",
        );
        minify_test(
            ".foo { width: calc(100px * pow(2, pow(2, 2)",
            ".foo{width:1600px}",
        );
    ...
    fn test_media() {
        ...
        minify_test(
            "@media { .foo { color: chartreuse }}",
            ".foo{color:#7fff00}",
        );
        minify_test(
            "@media all { .foo { color: chartreuse }}",
            ".foo{color:#7fff00}",
        );
        minify_test(
            "@media not (((color) or (hover))) { .foo { color: chartreuse }}",
      ...
      "#},
        ...
        error_test(
            "@media unknown(foo) {}",
            ParserError::UnexpectedToken(crate::properties::custom::Token::Function(
                "unknown".into(),
            )),
        );
        ...
        error_test(
            "@media screen and () {}",
            ParserError::EmptyBracketInCondition,
        );
    ...
    fn test_transitions() {
        minify_test(
            ".foo { transition-duration: 500ms }",
            ".foo{transition-duration:.5s}",
        );
        minify_test(
            ".foo { transition-duration: .5s }",
            ".foo{transition-duration:.5s}",
        ...
        minify_test(
            ".foo { transition-duration: 99ms }",
            ".foo{transition-duration:99ms}",
        );
        minify_test(
            ".foo { transition-duration: .099s }",
            ".foo{transition-duration:99ms}",
        );
        minify_test(
            ".foo { transition-duration: 2000ms }",
            ".foo{transition-duration:2s}",
        );
        minify_test(
            ".foo { transition-duration: 2s }",
            ".foo{transition-duration:2s}",
        ...
        minify_test(
            ".foo { transition-delay: 500ms }",
            ".foo{transition-delay:.5s}",
        );
        minify_test(
        ...
        minify_test(
            ".foo { transition: width 2s ease }",
            ".foo{transition:width 2s}",
        );
        minify_test(
        ...
        minify_test(
            ".foo { transition: width 2s 1s }",
            ".foo{transition:width 2s 1s}",
        );
        minify_test(
            ".foo { transition: width 2s ease 1s }",
            ".foo{transition:width 2s 1s}",
        );
        minify_test(
    ...
    fn test_animation() {
        ...
        minify_test(
            ".foo { animation-name: \"test\" }",
            ".foo{animation-name:test}",
        );
        minify_test(
            ".foo { animation-name: foo, bar }",
            ".foo{animation-name:foo,bar}",
        );
        minify_test(
        ...
        minify_test(
            ".foo { animation-name: none, none }",
            ".foo{animation-name:none,none}",
        );

        // Test CSS-wide keywords
        minify_test(
            ".foo { animation-name: unset }",
            ".foo{animation-name:unset}",
        );
        minify_test(
            ".foo { animation-name: \"unset\" }",
        ...
        minify_test(
            ".foo { animation-duration: 100ms }",
            ".foo{animation-duration:.1s}",
        );
        minify_test(
        ...
        minify_test(
            ".foo { animation: \"none\" 2s none}",
            ".foo{animation:2s \"none\"}",
        );
        minify_test(
            ".foo { animation: none \"none\" 2s}",
            ".foo{animation:2s \"none\"}",
        );
        minify_test(
        ...
        minify_test(
            ".foo { animation: \"string\" .5s }",
            ".foo{animation:.5s string}",
        );
        minify_test(
            ".foo { animation: \"unset\" .5s }",
            ".foo{animation:.5s \"unset\"}",
        );
        minify_test(
        ...
        minify_test(
            ...
            ".foo{animation:2s 1 infinite}",
        );
        minify_test(
            ".foo { animation: \"paused\" 2s }",
            ".foo{animation:2s running paused}",
        );
        minify_test(
        ...
        minify_test(
            ".foo { animation: foo 3s --test }",
            ".foo{animation:3s foo --test}",
        );
        minify_test(
            ".foo { animation: foo 3s scroll() }",
    ...
    "#},
        ...
        minify_test(
            ".foo { animation-range: 50% normal }",
            ".foo{animation-range:50%}",
        );
        minify_test(
    ...
    fn test_transform() {
        ...
        minify_test(
            ".foo { transform: scale(10%, 20%)",
            ".foo{transform:scale(.1,.2)}",
        );
        ...
        minify_test(
            ".foo { transform: scale3d(2, 3, 4)",
            ".foo{transform:scale3d(2,3,4)}",
        );
        minify_test(
            ".foo { transform: scale3d(2, 1, 1)",
            ".foo{transform:scaleX(2)}",
        );
        minify_test(
            ".foo { transform: scale3d(1, 2, 1)",
            ".foo{transform:scaleY(2)}",
        );
        minify_test(
            ".foo { transform: scale3d(1, 1, 2)",
            ".foo{transform:scaleZ(2)}",
        );
        minify_test(
            ".foo { transform: scale3d(2, 2, 1)",
            ".foo{transform:scale(2)}",
        );
        minify_test(
        ...
        minify_test(
            ".foo { transform: rotate(405deg)}",
            ".foo{transform:rotate(405deg)}",
        );
        minify_test(
            ".foo { transform: rotateX(405deg)}",
            ".foo{transform:rotateX(405deg)}",
        );
        minify_test(
            ".foo { transform: rotateY(405deg)}",
            ".foo{transform:rotateY(405deg)}",
        );
        minify_test(
            ".foo { transform: rotate(-200deg)}",
            ".foo{transform:rotate(-200deg)}",
        );
        minify_test(".foo { transform: rotate(0)", ".foo{transform:rotate(0)}");
        minify_test(
            ".foo { transform: rotate(0deg)",
            ".foo{transform:rotate(0)}",
        );
        minify_test(
        ...
        minify_test(
            ".foo { transform: skew(20deg)",
            ".foo{transform:skew(20deg)}",
        );
        minify_test(
            ".foo { transform: skew(20deg, 0deg)",
            ".foo{transform:skew(20deg)}",
        );
        minify_test(
            ".foo { transform: skew(0deg, 20deg)",
            ".foo{transform:skewY(20deg)}",
        );
        minify_test(
            ".foo { transform: skewX(20deg)",
            ".foo{transform:skew(20deg)}",
        );
        minify_test(
            ".foo { transform: skewY(20deg)",
        ...
        minify_test(
            ".foo { scale: 0.5; transform: scale(3); }",
            ".foo{transform:scale(3)}",
        );
    ...
    fn test_font_face() {
      ...
      font-style: italic;
        ...
        minify_test(
            "@font-face {src: url(test.woff);}",
            "@font-face{src:url(test.woff)}",
        );
        minify_test(
            "@font-face {src: local(\"Test\");}",
            "@font-face{src:local(Test)}",
        );
        minify_test(
        ...
        minify_test(
            "@font-face {font-stretch: 50% 50%}",
            "@font-face{font-stretch:50%}",
        );
        minify_test(
...
@font-feature-values "Inconsolata LGC" {
    ...
    fn test_page_rule() {
        ...
        minify_test(
            "@page toc, index {margin: 0.5cm}",
            "@page toc,index{margin:.5cm}",
        );
        minify_test(
            r#"
    @page :right {
    ...
    fn test_import() {
        ...
        minify_test(
            "@layer foo; @import url(foo.css);",
            "@layer foo;@import \"foo.css\";",
        );
        error_test(
    ...
    fn test_display() {
        ...
        minify_test(
            ".foo { display: block flow list-item }",
    ...
    fn test_wrap() {
        minify_test(
            ".foo { overflow-wrap: nOrmal }",
            ".foo{overflow-wrap:normal}",
        );
        minify_test(
            ".foo { overflow-wrap: break-Word }",
            ".foo{overflow-wrap:break-word}",
        );
        minify_test(
            ".foo { overflow-wrap: Anywhere }",
            ".foo{overflow-wrap:anywhere}",
        );
    ...
    fn test_text_indent() {
        ...
        minify_test(
            ".foo { text-indent: 3em hanging }",
            ".foo{text-indent:3em hanging}",
        );
        minify_test(
            ".foo { text-indent: 3em each-line }",
            ".foo{text-indent:3em each-line}",
        );
        minify_test(
    ...
    fn test_text_size_adjust() {
        ...
        minify_test(
            ".foo { text-size-adjust: auto }",
            ".foo{text-size-adjust:auto}",
        );
        minify_test(
            ".foo { text-size-adjust: 80% }",
            ".foo{text-size-adjust:80%}",
        );
        prefix_test(
            r#"
    ...
    fn test_text_emphasis() {
        ...
        minify_test(
            ".foo { text-emphasis-style: \"x\" }",
            ".foo{text-emphasis-style:\"x\"}",
        );

        minify_test(
            ".foo { text-emphasis-color: yellow }",
            ".foo{text-emphasis-color:#ff0}",
        );

        minify_test(".foo { text-emphasis: none }", ".foo{text-emphasis:none}");
        minify_test(
            ".foo { text-emphasis: filled }",
            ".foo{text-emphasis:filled}",
        );
        minify_test(
    ...
    fn test_list() {
        ...
        minify_test(
            ".foo { list-style: none none outside; }",
            ".foo{list-style:none}",
        );
        minify_test(
            ".foo { list-style: none none inside; }",
            ".foo{list-style:inside none}",
        );
        minify_test(
        ...
        minify_test(
            ".foo { list-style: none disc; }",
            ".foo{list-style:outside}",
        );
        minify_test(
            ".foo { list-style: none inside disc; }",
    ...
    fn test_color() {
        ...
        minify_test(".foo { color: rgb(123 255 255) }", ".foo{color:#7bffff}");
        minify_test(
            ".foo { color: rgb(123 255 255 / .5) }",
            ".foo{color:#7bffff80}",
        );
        minify_test(
            ".foo { color: rgb(123 255 255 / 50%) }",
            ".foo{color:#7bffff80}",
        );
        minify_test(
            ".foo { color: rgb(48% 100% 100% / 50%) }",
            ".foo{color:#7affff80}",
        );
        ...
        minify_test(
            ".foo { color: color(xyz 0 0 0); }",
            ".foo{color:color(xyz 0 0 0)}",
        );
        minify_test(
            ".foo { color: color(xyz 0 1 0); }",
            ".foo{color:color(xyz 0 1 0)}",
        );
        minify_test(
    ...
    fn test_relative_color() {
        ...
        test(
            "lab(from indianred calc(l * .8) a b)",
            "lab(43.1402% 45.7516 23.1557)",
        );
        test(
            "lch(from indianred calc(l + 10) c h)",
            "lch(63.9252% 51.2776 26.8448)",
        );
        test(
            "lch(from indianred l calc(c - 50) h)",
            "lch(53.9252% 1.27763 26.8448)",
        );
        test(
        ...
        test(
            "lch(from indianred l sin(c) h)",
            "lch(53.9252% .84797 26.8448)",
        );
        test(
            "lch(from indianred l sqrt(c) h)",
            "lch(53.9252% 7.16084 26.8448)",
        );
        test(
            "lch(from indianred l c sin(h))",
            "lch(53.9252% 51.2776 .451575)",
        );
        test(
            "lch(from indianred calc(10% + 20%) c h)",
            "lch(30% 51.2776 26.8448)",
        );
        test(
            "lch(from indianred calc(10 + 20) c h)",
            "lch(30% 51.2776 26.8448)",
        ...
        test(
            "lch(from indianred l c calc(10 + 20))",
        ...
        test(
            "rgb(from rgb(20%, 40%, 60%, 80%) r g b / 0)",
            "rgba(51, 102, 153, 0)",
        );
        ...
        test(
            "rgb(from rebeccapurple r 25 b / alpha)",
            "rgb(102, 25, 153)",
        );
        test("rgb(from rebeccapurple r g 25 / alpha)", "rgb(102, 51, 25)");
        test(
            "rgb(from rebeccapurple r g b / .25)",
        ...
        test(
            "rgb(from rebeccapurple r 20% b / alpha)",
            "rgb(102, 51, 153)",
        );
        test(
            "rgb(from rebeccapurple r g 20% / alpha)",
            "rgb(102, 51, 51)",
        );
        test(
            "rgb(from rebeccapurple r g b / 20%)",
            "rgba(102, 51, 153, 0.2)",
        );
        test(
        ...
        test(
            "rgb(from rebeccapurple 25 g b / 25%)",
            "rgba(25, 51, 153, 0.25)",
        );
        test(
            "rgb(from rebeccapurple r 25 b / 25%)",
            "rgba(102, 25, 153, 0.25)",
        );
        test(
            "rgb(from rebeccapurple r g 25 / 25%)",
            "rgba(102, 51, 25, 0.25)",
        );
        test(
        ...
        test(
            "rgb(from rebeccapurple b alpha r / g)",
            "rgba(153, 1, 102, 1)",
        );
        test(
            "rgb(from rebeccapurple r r r / r)",
            "rgba(102, 102, 102, 1)",
        );
        test(
        ...
        test(
            "rgb(from rgb(20%, 40%, 60%, 80%) g b r)",
            "rgb(102, 153, 51)",
        );
        test(
        ...
        test(
            "rgb(from rgb(20%, 40%, 60%, 80%) r r r / r)",
            "rgba(51, 51, 51, 1)",
        );
        test(
        ...
        test(
            "rgb(from rgb(20%, 40%, 60%, 80%) r 20% 10)",
            "rgb(51, 51, 10)",
        );
        test(
            "rgb(from rgb(20%, 40%, 60%, 80%) r 10 20%)",
            "rgb(51, 10, 51)",
        );
        test(
        ...
        test(
            "rgb(from rebeccapurple r calc(g * 2) 10)",
            "rgb(102, 102, 10)",
        );
        test(
            "rgb(from rebeccapurple b calc(r * .5) 10)",
            "rgb(153, 51, 10)",
        );
        test(
            "rgb(from rebeccapurple r calc(g * .5 + g * .5) 10)",
            "rgb(102, 51, 10)",
        );
        test(
            "rgb(from rebeccapurple r calc(b * .5 - g * .5) 10)",
            "rgb(102, 51, 10)",
        );
        test(
        ...
        test(
            "rgb(from rebeccapurple r g b / none)",
            "rgba(102, 51, 153, 0)",
        );
        test(
        ...
        test(
            "rgb(from rgb(20% 40% 60% / 80%) r g b / none)",
            "rgba(51, 102, 153, 0)",
        );
        ...
        test(
            "rgb(from rgb(none none none / none) r g b / alpha)",
            "rgba(0, 0, 0, 0)",
        );
        ...
        // Test nesting relative colors.
        test(
            "hsl(from hsl(from rebeccapurple h s l) h s l)",
            "rgb(102, 51, 153)",
        );

        // Testing non-sRGB origin colors to see gamut mapping.
        test(
            "hsl(from color(display-p3 0 1 0) h s l / alpha)",
            "rgb(0, 249, 66)",
        ...
        test(
            "hsl(from oklab(100% 0.365 -0.16) h s l)",
            "rgb(255, 255, 255)",
        ...
        test(
            "hsl(from oklch(100% 0.399 336.3) h s l)",
            "rgb(255, 255, 255)",
        ...
        test(
            "hsl(from rebeccapurple 0deg s l / alpha)",
            "rgb(153, 51, 51)",
        );
        test(
        ...
        test(
            "hsl(from rgb(20%, 40%, 60%, 80%) h s 0% / alpha)",
            "rgba(0, 0, 0, 0.8)",
        );
        test(
            "hsl(from rgb(20%, 40%, 60%, 80%) h s l / 0)",
            "rgba(51, 102, 153, 0)",
        );
        ...
        test(
            "hsl(from rebeccapurple 25deg s l / alpha)",
            "rgb(153, 94, 51)",
        );
        test(
            "hsl(from rebeccapurple h 20% l / alpha)",
            "rgb(102, 82, 122)",
        );
        test("hsl(from rebeccapurple h s 20% / alpha)", "rgb(51, 25, 77)");
        test(
            "hsl(from rebeccapurple h s l / .25)",
            "rgba(102, 51, 153, 0.25)",
        );
        test(
        ...
        test(
            "hsl(from rgb(20%, 40%, 60%, 80%) h l s)",
            "rgb(77, 128, 179)",
        );
        test(
        ...
        // Testing with calc().
        test(
            "hsl(from rebeccapurple calc(h) calc(s) calc(l))",
            "rgb(102, 51, 153)",
        );
        test(
        ...
        test(
            "hsl(from rebeccapurple h s l / none)",
            "rgba(102, 51, 153, 0)",
        );
        test(
            "hsl(from rebeccapurple none s l / alpha)",
            "rgb(153, 51, 51)",
        );
        test(
        ...
        test(
            "hsl(from hsl(none none none / none) h s l / alpha)",
            "rgba(0, 0, 0, 0)",
        );
        test(
            "hsl(from hsl(120deg none 50% / .5) h s l)",
            "rgb(128, 128, 128)",
        );
        test(
        ...
        // Testing non-sRGB origin colors to see gamut mapping.
        test(
            "hwb(from color(display-p3 0 1 0) h w b / alpha)",
            "rgb(0, 249, 66)",
        ); // Naive clip based mapping would give rgb(0, 255, 0).
        test(
        ...
        test(
            "hwb(from oklab(100% 0.365 -0.16) h w b)",
            "rgb(255, 255, 255)",
        ); // Naive clip based mapping would give rgb(255, 92, 255).
        ...
        for color_space in &["lab", "oklab"] {
            ...
            test(
                &format!(
                    "{}(from color(display-p3 0 0 0) l a b / alpha)",
                    color_space
                ),
            ...
            test(
                &format!(
                    "{}(from {}(25% 20 50) none none none / none)",
                    color_space, color_space
                ),
            ...
            test(
                &format!(
                    "{}(from {}(25% 20 50 / none) l a b / alpha)",
                    color_space, color_space
                ),
                &format!("{}(25% 20 50 / 0)", color_space),
            );
        ...
        for color_space in &["lch", "oklch"] {
            ...
            test(
                &format!(
                    "{}(from color(display-p3 0 0 0) l c h / alpha)",
                    color_space
                ),
                &format!("{}(0% 0 0)", color_space),
            );
            ...
            test(
                &format!(
                    "{}(from {}(70% 45 30) none none none / none)",
                    color_space, color_space
                ),
                &format!("{}(none none none / none)", color_space),
            );
            ...
            test(
                &format!(
                    "{}(from {}(70% 45 30 / none) l c h / alpha)",
                    color_space, color_space
                ),
                &format!("{}(70% 45 30 / 0)", color_space),
            );
        ...
        for color_space in &["srgb", "srgb-linear", "a98-rgb", "rec2020", "prophoto-rgb"] {
            ...
            test(
                &format!(
                    "color(from color({} 0.7 0.5 0.3) {} 0 0 0)",
                    color_space, color_space
                ),
            ...
            test(
                &format!(
                    "color(from color({} 0.7 0.5 0.3) {} g b r)",
                    color_space, color_space
                ),
            ...
            test(
                &format!(
                    "color(from color({} 1.7 1.5 1.3) {} r g b)",
                    color_space, color_space
                ),
            ...
            test(
                &format!(
                    "color(from color({} 0.7 none 0.3) {} r g b)",
                    color_space, color_space
                ),
                &format!("color({} 0.7 0 0.3)", color_space),
            );
        ...
        for color_space in &["xyz", "xyz-d50", "xyz-d65"] {
            let result_color_space = if *color_space == "xyz" {
                "xyz-d65"
            } else {
                color_space
            };
            ...
            test(
                &format!(
                    "color(from color({} 7 -20.5 100) {} x y z)",
                    color_space, color_space
                ),
            ...
            test(
                &format!(
                    "color(from color({} 7 -20.5 100) {} 0 0 0)",
                    color_space, color_space
                ),
            ...
            test(
                &format!(
                    "color(from color({} 7 -20.5 100) {} y z x)",
                    color_space, color_space
                ),
            ...
            test(
                &format!(
                    "color(from color({} 7 none 100) {} x y z)",
                    color_space, color_space
                ),
                &format!("color({} 7 0 100)", result_color_space),
            );
    ...
    fn test_color_mix() {
      ...
      "# },
        ...
        fn canonicalize(s: &str) -> String {
            ...
            format!(
                ".foo{{color:{}}}",
                v.to_css_string(PrinterOptions::default()).unwrap()
            )
        }
        ...
        for color_space in ["lab", "oklab"] {
            ...
            minify_test(
                ...
                &format!(
                    ".foo{{color:{}(44.2857% 54.2857 64.2857/.35)}}",
                    color_space
                ),
            ); // Scale up < 100% sum, causes alpha multiplication.
            minify_test(
        ...
        for color_space in [/*"srgb", */ "srgb-linear", "xyz", "xyz-d50", "xyz-d65"] {
            ...
            let result_color_space = if color_space == "xyz-d65" {
                "xyz"
            } else {
                color_space
            };
    ...
    fn test_grid() {
        ...
        minify_test(
            ".foo { grid-template-columns: [linename1 linename2] 100px repeat(auto-fit, [linename1] 300px) [linename3]; }",
            ".foo{grid-template-columns:[linename1 linename2]100px repeat(auto-fit,[linename1]300px)[linename3]}",
        );
        minify_test(
  ...
  "#,
    ...
    "#,
      ...
      "#},
        ...
        minify_test(
            ".foo { grid-auto-flow: row dense }",
            ".foo{grid-auto-flow:dense}",
        );
        minify_test(
            ".foo { grid-auto-flow: dense row }",
            ".foo{grid-auto-flow:dense}",
        );
        minify_test(
        ...
        minify_test(
            ".foo { grid: 200px / auto-flow }",
            ".foo{grid:200px/auto-flow}",
        );
        minify_test(
            ".foo { grid: 30% / auto-flow dense }",
            ".foo{grid:30%/auto-flow dense}",
        );
        minify_test(
            ".foo { grid: 30% / dense auto-flow }",
            ".foo{grid:30%/auto-flow dense}",
        );
        minify_test(
        ...
        minify_test(
            ".foo { grid: none / auto-flow 1fr }",
            ".foo{grid:none/auto-flow 1fr}",
        );

        minify_test(".foo { grid: auto-flow / 200px }", ".foo{grid:none/200px}");
        minify_test(
            ".foo { grid: auto-flow dense / 30% }",
            ".foo{grid:auto-flow dense/30%}",
        );
        minify_test(
            ".foo { grid: dense auto-flow / 30% }",
            ".foo{grid:auto-flow dense/30%}",
        );
        minify_test(
        ...
        minify_test(
            ".foo { grid-area: a / b / c / d }",
            ".foo{grid-area:a/b/c/d}",
        );

        minify_test(
            ".foo { grid-area: auto / auto / auto / auto }",
            ".foo{grid-area:auto}",
        );
        minify_test(".foo { grid-area: 1 / auto }", ".foo{grid-area:1}");
        minify_test(
            ".foo { grid-area: 1 / 2 / 3 / 4 }",
            ".foo{grid-area:1/2/3/4}",
        );
        minify_test(
            ".foo { grid-area: 1 / 1 / 1 / 1 }",
            ".foo{grid-area:1/1/1/1}",
        );
  ...
  ");
    ...
    "#},
        ...
        for name in &[
            ...
            css_modules_test(
                &format!(":root::{}(foo.bar.baz) {{position: fixed}}", name),
                &format!(
                    ":root::{}(EgL3uq_foo.EgL3uq_bar.EgL3uq_baz){{position:fixed}}",
                    name
                ),
                map! {
                  "foo" => "EgL3uq_foo",
    ...
    fn test_svg() {
        ...
        minify_test(
            ".foo { stroke: url(#foo) none; }",
            ".foo{stroke:url(#foo) none}",
        );
        minify_test(
            ".foo { stroke: url(#foo) yellow; }",
            ".foo{stroke:url(#foo) #ff0}",
        );
        minify_test(".foo { stroke: none; }", ".foo{stroke:none}");
        minify_test(
            ".foo { stroke: context-fill; }",
            ".foo{stroke:context-fill}",
        );
        minify_test(
            ".foo { stroke: context-stroke; }",
            ".foo{stroke:context-stroke}",
        );

        minify_test(
            ".foo { marker-start: url(#foo); }",
            ".foo{marker-start:url(#foo)}",
        );
    ...
    "#},
        ...
        assert_eq!(
            property,
            Property::ColorInterpolation(svg::ColorInterpolation::SRGB)
        );
    }
    ...
    fn test_filter() {
        ...
        minify_test(
            ".foo { filter: brightness(10%); }",
            ".foo{filter:brightness(10%)}",
        );
        minify_test(
            ".foo { filter: brightness(100%); }",
            ".foo{filter:brightness()}",
        );
        minify_test(
        ...
        minify_test(
            ".foo { filter: hue-rotate(0) }",
            ".foo{filter:hue-rotate()}",
        );
    ...
    fn test_api() {
        let stylesheet =
            StyleSheet::parse(".foo:hover { color: red }", ParserOptions::default()).unwrap();
    ...
    .foo {
      color: red;
        ...
        let property =
            Property::parse_string("color".into(), "#f0f", ParserOptions::default()).unwrap();
        assert_eq!(
            property
        ...
        assert_eq!(
            property
                .to_css_string(true, PrinterOptions::default())
                .unwrap(),
            "color: #f0f !important"
        );
    ...
    "#};
        ...
        if let CssRule::Style(style) = &stylesheet.rules.0[1] {
            ...
            assert_eq!(
                key,
                SourceLocation { line: 6, column: 3 }..SourceLocation {
                    line: 6,
                    column: 13
                }
            );
        ...
        assert_eq!(
            property,
            Property::Transform(Default::default(), VendorPrefix::None)
        );
        property.set_prefix(VendorPrefix::Moz);
        assert_eq!(
            property,
            Property::Transform(Default::default(), VendorPrefix::Moz)
        );
    ...
    fn test_substitute_vars() {
            ...
            if let Property::Unparsed(unparsed) = property {
                let vars = vars
                    ...
                    .map(|(k, v)| {
                        (
                            k,
                            TokenList::parse_string_with_options(v, ParserOptions::default())
                                .unwrap(),
                        )
                    })
                    .collect();
        ...
        let property =
            Property::parse_string("color".into(), "var(--test)", ParserOptions::default())
                .unwrap();
        test(
            property,
            HashMap::from([("--test", "yellow")]),
            "color: #ff0",
        );
        ...
        test(
            property,
            HashMap::from([("--a", "2px"), ("--b", "4px")]),
            "width: 6px",
        );

        let property =
            Property::parse_string("color".into(), "var(--a)", ParserOptions::default()).unwrap();
        test(
            property,
    ...
    "#,
            ParserError::UnexpectedToken(crate::properties::custom::Token::Ident(
                "property-name".into(),
            )),
        );
...
"#,
    ...
    */
    ...
    "#;
        ...
        sm.set_source_content(source_index as usize, source)
            .unwrap();
        ...
        assert_eq!(
            *warnings,
            vec![
                ...
                Error {
                    kind: ParserError::SelectorError(SelectorError::UnsupportedPseudoClass(
                        "placeholder".into()
                    )),
                    loc: Some(ErrorLocation {
                        filename: "test.css".into(),
                ...
                Error {
                    kind: ParserError::SelectorError(SelectorError::UnsupportedPseudoElement(
                        "hover".into()
                    )),
                    loc: Some(ErrorLocation {
                        filename: "test.css".into(),
    ...
    "#,
        ...
        minify_test(
            ".foo { width: calc(1cqmin + 2cqmin) }",
            ".foo{width:3cqmin}",
        );
        minify_test(
            ".foo { width: calc(1cqmax + 2cqmax) }",
            ".foo{width:3cqmax}",
        );
    ...
    fn test_color_scheme() {
        ...
        minify_test(
            ".foo { color-scheme: dark light; }",
            ".foo{color-scheme:light dark}",
        );
        minify_test(
            ".foo { color-scheme: only light; }",
            ".foo{color-scheme:light only}",
        );
        minify_test(
            ".foo { color-scheme: only dark; }",
    ...
    fn test_all() {
        ...
        minify_test(
            ".foo { background: red; all: revert-layer }",
            ".foo{all:revert-layer}",
        );
        minify_test(
        ...
        minify_test(
            ".foo { background: var(--foo); all: unset; }",
            ".foo{all:unset}",
        );
        minify_test(
